 ...
 * This component is used to sign up to the application.
 */
...
const Signup = () => {
  ...
  //state to save the role error
  const [roleError, setRoleError] = useState<boolean>(false);

  //state to save the role error message
  ...
  const fetchData = async () : Promise<void> => {
    try {
      ...
      //Checking if the user is signed up successfully
      if (!data.error) {
  ...
  const validateInputs = () : boolean => {
    ...
    //Checking if the role is valid and displaying the error message if it is not valid
    if (!role) {
      setRoleError(true);
      setRoleErrorMessage("There should be a role.");
      isValid = false;
    } else {
      setPasswordError(false);
      setPasswordErrorMessage("");
        ...
        <SignUpContainer direction="column" justifyContent="space-between">
          <Card variant="outlined">
            ...
            >
              ...
              <FormControl>
                <FormLabel htmlFor="rolw">Role</FormLabel>
                <TextField
                  error={roleError}
